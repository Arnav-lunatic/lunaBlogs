...
function Nav() {
    return (
        <div className='fixed top-0 right-0 left-0 z-50 bg-gray-200 shadow-md bg-opacity-60 backdrop-blur-lg px-4 py-2 flex flex-col gap-8 lg:flex-row items-center justify-between ' >
